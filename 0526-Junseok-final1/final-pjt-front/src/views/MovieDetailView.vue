  ...
  <div class="MovieDetailView">
      ...
      <div class="movie-detail">
        <div class="movie-detail-content">
          ...
          <div class="movie-info">
            ...
            <button @click.prevent="movieLikes" :class="{'red-like': movieLiked}">
              좋아요
              <i
                class="fa-sharp fa-solid fa-thumbs-up"
                :style="{ color: movieLiked ? 'white' : '#707070'}"
              ></i>
            </button>
    ...
    <div class="movie-detail-container">
      <div class="actor-detail">
        <h1 class="actorinformation">영화 배우 정보</h1>
        <div class="actors">
          <ActorCard
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      movieLiked: (state) => state.movieLikeModule.movieLiked,
    }),
