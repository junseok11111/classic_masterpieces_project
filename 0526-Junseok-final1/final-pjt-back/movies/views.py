...
def movie_likes(request, movie_pk):
    ...
    if request.method == 'GET':
        ...
        movie_liked = movie.like_users.filter(pk=request.user.pk).exists()
        serializer = MovieLikeCountSerializer({'movie_like_count': movie_like_count, 'movie_liked': movie_liked})
        return Response(serializer.data)
