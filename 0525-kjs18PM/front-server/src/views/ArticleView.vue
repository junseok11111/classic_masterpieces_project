    ...
    <div class="article_table">
      ...
      <div @click.stop>
        <form v-if="article_form" @submit="createArticle" >
          <textarea id="title" cols="70" rows="1" placeholder="제목을 입력하세요." v-model.trim="title"></textarea><br>
          <textarea id="content" cols="70" rows="10" placeholder="내용을 입력하세요." v-model.trim="content"></textarea>
