...
urlpatterns = [
    ...
    # --- 장르별 영화 데이터 ---
    path('movies/thriller/', views.movie_thriller_list), # 공포/스릴러 (공포, 스릴러만 포함) 53
    path('movies/science_fiction/', views.movie_science_fiction_list), # 공포/SF 878
    path('movies/action/', views.movie_action_list), # 공포/액션 28
    path('movies/mystery/', views.movie_mystery_list), # 공포/미스터리 9648
    ...
    # --- 영화 좋아요 ---
    path('movies/<int:movie_pk>/movie_likes/', views.movie_likes),  # 영화 좋아요 추가, 제거, 조회

    # --- 유저가 좋아요 누른 영화 리스트 ---
    path('user/movie_likes/', views.user_movie_likes_list),
